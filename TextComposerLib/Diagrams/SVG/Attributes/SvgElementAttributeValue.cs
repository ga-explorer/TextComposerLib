...
{
    /// <summary>
    /// This class holds information about the value of an atrribute for a parent element
    /// </summary>
    /// <typeparam name="TParentElement"></typeparam>
    public abstract class SvgElementAttributeValue<TParentElement> : ISvgAttributeValue where TParentElement : SvgElement
    {
