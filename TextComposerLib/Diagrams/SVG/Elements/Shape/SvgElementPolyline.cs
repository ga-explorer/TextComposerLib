...
namespace TextComposerLib.Diagrams.SVG.Elements.Shape
{
    public sealed class SvgElementPolyline : SvgElement, ISvgBasicShapeElement
    {
        ...
        public SvgElementPolyline SetPoints(IEnumerable<Tuple<double, double>> points)
        {
            return SetPoints(SvgValuePointsList.Create(points));
        }

        public SvgElementPolyline SetPoints(SvgValueLengthUnit unit, IEnumerable<Tuple<double, double>> points)
        {
